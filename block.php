...
<body>
<div class="content">
<?php create_topmenu(3); ?>

<div class="clr">
	<h3>Block Level Winners</h3>

<div class="container">
  <form action="blocksave.php" method="POST">

    Block Code &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" id="block" name="bid" placeholder="--Block code--"><br>

    Participant code &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <select id="pcode" name="pcode">
      <option value="--select--">--select--</option>
     <?php
        $sql="SELECT * FROM entry ORDER BY p_code";

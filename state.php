...
<body>
<div class="content">
<?php create_topmenu(5); ?>
<div class="clr">
	<h3>State Level Winners</h3>

<div class="container">
  <form action="statesave.php" method="POST">
  	

    District code &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
     <select id="district id" name="did">
      <option value="--select--">--select--</option>
       <?php
        $sql="SELECT * FROM district ORDER BY d_id";
    ...
    <select id="pcode" name="pcode">
      <option value="--select--">--select--</option>
      <?php
        $sql="SELECT a.p_code FROM entry a,district b where a.p_code=b.p_code ORDER BY p_code";
       //$result=$conn->query($sql);
        $result = mysqli_query($conn,$sql);
      //var_dump($result);
